...
<center><img src="images/LNCT.jpg" width="150" height="150">
<img src="images/apj sir.png" align="right"  width="150" height="150"></center>
    <a href="LNCTOneView.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
...
Designed & Developed by Saraf Team</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Saraf.Com :: 2021-2028</h6></center> 
  <hr class="new1">
</body>
<% 
 }
...
{
    response.sendRedirect("errorLNCTOneView.html");
}
}
catch(Exception e)
{
